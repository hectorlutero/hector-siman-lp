      ...
      <div className="max-w-6xl mx-auto">
            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className="w-full max-w-md lg:w-2/5 lg:max-w-md mx-auto lg:mx-0 relative"
                >
                  {/* Phase glow — SIBLING of card so overflow-hidden doesn't clip it */}
                  <div
                    aria-hidden="true"
                    className="pointer-events-none absolute -inset-16 md:-inset-20 blur-[80px] -z-10"
                    style={{ background: `radial-gradient(ellipse at center, ${phase.glow} 0%, transparent 65%)` }}
                  />
                      ...
                      {i === 1 && (
                        ...
                        <div className="w-full h-full border-2 border-warning/30 bg-warning/5 rounded-xl flex flex-col opacity-100 relative overflow-hidden">
                          ...
                          <motion.div
                            ...
                            transition={{ duration: 9, repeat: Infinity, times: [0, 0.22, 0.26, 0.92, 0.96, 1] }}
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between border-b border-warning/20 pb-3">
                              <div className="flex items-center gap-4">
                                ...
                                <div className="w-10 h-10 rounded-full border border-warning/50 flex items-center justify-center bg-warning/10 relative shadow-[0_0_10px_rgba(245,158,11,0.2)]">
                                  ...
                                  <motion.div animate={{ opacity: [0, 0, 1, 1, 0, 0] }} transition={{ duration: 9, repeat: Infinity, ease: "linear", times: [0, 0.25, 0.26, 0.71, 0.72, 1] }} className="flex gap-1">
                                    <div className="w-1 h-3 bg-warning" />
                                    <div className="w-1 h-3 bg-warning" />
                                  </motion.div>
                                  {/* Play Icon. Toggles instantly to 1 at 0.72 */}
                                  <motion.div animate={{ opacity: [1, 1, 0, 0, 1, 1] }} transition={{ duration: 9, repeat: Infinity, ease: "linear", times: [0, 0.25, 0.26, 0.71, 0.72, 1] }} className="absolute w-0 h-0 border-t-[6px] border-t-transparent border-l-[10px] border-l-warning border-b-[6px] border-b-transparent ml-1" />
                                </div>
                              ...
                              <div className="text-xs text-warning/70 font-mono tracking-widest relative w-16 h-4">
                                ...
                                <motion.span animate={{ opacity: [0, 0, 1, 1, 0, 0] }} transition={{ duration: 9, repeat: Infinity, times: [0, 0.25, 0.26, 0.55, 0.60, 1] }} className="absolute right-0">DATA_01</motion.span>
                                {/* DATA_02 Text: Fades in at 0.60, Fades out at 0.96 */}
                                <motion.span animate={{ opacity: [0, 0, 0, 1, 1, 0] }} transition={{ duration: 9, repeat: Infinity, times: [0, 0.55, 0.60, 0.65, 0.92, 0.96] }} className="absolute right-0 text-warning font-bold">DATA_02</motion.span>
                              </div>
                            </div>
                            ...
                            <div className="flex-1 relative">
                              ...
                              <motion.div
                                ...
                                animate={{ opacity: [0, 0, 1, 1, 0, 0] }}
                                transition={{ duration: 9, repeat: Infinity, times: [0, 0.25, 0.26, 0.55, 0.60, 1] }}
                              ...
                              >
                                ...
                                <div className="w-24 h-24 relative flex items-center justify-center shrink-0">
                                  <svg className="w-full h-full -rotate-90">
                                    ...
                                    <motion.circle cx="48" cy="48" r="36" stroke="#f59e0b" strokeWidth="12" fill="none" strokeDasharray="226" animate={{ strokeDashoffset: [226, 226, 60, 60, 226, 226] }} transition={{ duration: 9, repeat: Infinity, times: [0, 0.26, 0.32, 0.90, 0.92, 1], ease: "easeInOut" }} />
                                  </svg>
                                ...
                                <div className="flex-1 h-24 flex items-end justify-around gap-2">
                                  <motion.div animate={{ height: ["0%", "0%", "80%", "80%", "0%", "0%"] }} transition={{ duration: 9, repeat: Infinity, times: [0, 0.26, 0.32, 0.90, 0.92, 1] }} className="w-full bg-warning/60 rounded-t-sm" />
                                  <motion.div animate={{ height: ["0%", "0%", "60%", "60%", "0%", "0%"] }} transition={{ duration: 9, repeat: Infinity, times: [0, 0.26, 0.32, 0.90, 0.92, 1] }} className="w-full bg-warning/80 rounded-t-sm" />
                                  <motion.div animate={{ height: ["0%", "0%", "100%", "100%", "0%", "0%"] }} transition={{ duration: 9, repeat: Infinity, times: [0, 0.26, 0.32, 0.90, 0.92, 1] }} className="w-full bg-warning rounded-t-sm shadow-[0_0_15px_rgba(245,158,11,0.5)]" />
                                  <motion.div animate={{ height: ["0%", "0%", "40%", "40%", "0%", "0%"] }} transition={{ duration: 9, repeat: Infinity, times: [0, 0.26, 0.32, 0.90, 0.92, 1] }} className="w-full bg-warning/40 rounded-t-sm" />
                                </div>
                              </motion.div>
                              ...
                              <motion.div
                                ...
                                transition={{ duration: 9, repeat: Infinity, times: [0, 0.55, 0.60, 0.65, 0.92, 0.96, 1] }}
                                className="absolute inset-0 flex gap-6 items-center"
                              >
                                {/* Area Chart */}
                                <div className="flex-[1.2] h-24 border border-warning/20 rounded-lg bg-warning/5 relative overflow-hidden flex items-end">
                                  ...
                                  <svg viewBox="0 0 100 50" preserveAspectRatio="none" className="absolute bottom-0 w-full h-full pt-4">
                                    <motion.path
                                      ...
                                      animate={{ opacity: [0, 0, 0, 1, 1, 0, 0] }}
                                      transition={{ duration: 9, repeat: Infinity, times: [0, 0.50, 0.55, 0.65, 0.90, 0.92, 1] }}
                                    />
                                    <motion.path
                                ...
                                <div className="flex-[0.8] h-20 flex flex-col justify-around gap-2">
                                  <div className="w-full h-3 bg-warning/20 rounded-full overflow-hidden">
                                    <motion.div className="h-full bg-warning shadow-[0_0_10px_rgba(245,158,11,0.5)]" animate={{ width: ["0%", "0%", "0%", "85%", "85%", "0%", "0%"] }} transition={{ duration: 9, repeat: Infinity, times: [0, 0.50, 0.55, 0.65, 0.90, 0.92, 1] }} />
                                  </div>
                                  <div className="w-full h-3 bg-warning/20 rounded-full overflow-hidden">
                                    <motion.div className="h-full bg-warning/70" animate={{ width: ["0%", "0%", "0%", "45%", "45%", "0%", "0%"] }} transition={{ duration: 9, repeat: Infinity, times: [0, 0.50, 0.55, 0.65, 0.90, 0.92, 1] }} />
                                  </div>
                                  <div className="w-full h-3 bg-warning/20 rounded-full overflow-hidden">
                                    <motion.div className="h-full bg-warning/40" animate={{ width: ["0%", "0%", "0%", "65%", "65%", "0%", "0%"] }} transition={{ duration: 9, repeat: Infinity, times: [0, 0.50, 0.55, 0.65, 0.90, 0.92, 1] }} />
                                  </div>
                                </div>
                              </motion.div>
                            </div>
                ...
                >
                  <div className="flex items-center gap-4 mb-2">
                    <span className={`text-6xl font-black ${phase.numColor} select-none tracking-tighter`}>
                      {phase.num}
                    </span>
        ...
        >
          <Button
            ...
            external
          >
            {t("Aplicar à minha empresa", "Apply this to my company")}
          </Button>
        </motion.div>
